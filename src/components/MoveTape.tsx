 ...
 *
 * It counts up and never counts down. How few moves a solution *could* take
 * belongs in the solved notice, after the puzzle is won, not as a budget
 * ticking away while a child is still thinking.
 */
